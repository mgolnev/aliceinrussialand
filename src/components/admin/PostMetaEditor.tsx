      ...
      <div className="rounded-2xl border border-stone-200/80 bg-white/90 px-4 py-4 sm:px-5 sm:py-5">
        ...
        <p className="mt-3 text-[13px] leading-snug text-stone-500">
          {post.aiStatus === "PENDING" || post.aiStatus === "RUNNING"
            ? "Название, адрес, SEO и alt для изображений готовятся в фоне."
            : post.aiStatus === "DONE"
              ? "Название, адрес, SEO и alt для изображений подготовлены автоматически."
              : post.aiStatus === "REVIEW"
                ...
                : "После публикации название, адрес, SEO и alt для изображений подготовятся сами."}
        </p>
      </div>
