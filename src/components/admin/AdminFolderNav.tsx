...
export function AdminFolderNav() {
  ...
  const wanderActive = pathname.startsWith("/admin/wander");
  const webmasterActive = pathname.startsWith("/admin/webmaster");
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        prefetch
        className={`relative ${pillTabClass(webmasterActive)}`}
      >
        Индексация
        <LinkPendingBackdrop />
      </Link>
