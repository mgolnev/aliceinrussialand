...
/** Один спокойный абзац после поста — без отдельной карточки и служебных подписей. */
export function PostProjectTags({ projects }: { projects: PublishedProject[] }) {
  if (!projects.length) return null;

  return (
    <p className="mt-5 px-1 text-base leading-7 text-stone-700 sm:mt-6">
