      ...
      {next ? (
        <div className="flex justify-center pb-8">
          <button
            ...
            disabled={loading}
            className="rounded-full border border-stone-300 bg-white/90 px-6 py-2.5 text-sm font-medium text-stone-800 transition hover:border-stone-400 disabled:opacity-60"
          >
